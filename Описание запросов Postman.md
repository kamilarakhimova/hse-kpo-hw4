...
Иначе система выдаёт сообщение с описанием проблемы (например, отсутствие информации о блюде в базе данных, отсутствие необходимого количества желаемых блюд и пр.).
...
Иначе система выдаёт сообщение с описанием проблемы.
...
###     ◉ Предоставление информации о заказе ("delete_requests")
